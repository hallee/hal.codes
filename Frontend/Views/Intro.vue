  ...
  <section class="intro">
    <div>
      <article>
        ...
        <p>In free time I <a href="https://github.com/hallee" title="Hal on GitHub">write open source software</a> and write a bit on my <a href="https://blog.hal.codes">blog</a>. <br>Here you can find a small showcase of apps and features I’ve worked on recently.</p>
      </article>
    </div>
...
export default {
  components: {
    Playground: () => import('./Playground.vue'),
    Logo
  },
  data () {
    return {
  ...
  computed: {
    ...
    logoColor: function () {
      return this.setLogoColor || this.initialLogoColor
    }
  }
}
</script>
